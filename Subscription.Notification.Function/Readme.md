...
Execute unit tests
```
    cd "Subscription.Notification.Function/test/Subscription.Notification.Function.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Subscription.Notification.Function/src/Subscription.Notification.Function"
